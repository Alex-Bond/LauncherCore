...
public class AuthResponse extends Response {
    ...
    public String getErrorMessage() {
        ...
        if (this.availableProfiles != null && this.availableProfiles.length == 0 && (message == null || message.isEmpty())) {
            return "Даннай аккаунт не имеет лицензии. Попробуйте пиратский режим.";
        } else {
            if (message.contains("Account migrated"))
                return "Неверные данные. Аккаунт мигрировал. Используйте email как имя пользователя.";
            return message;
        }
    }
